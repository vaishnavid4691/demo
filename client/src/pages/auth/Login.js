...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-yellow-50 to-orange-100 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="absolute bottom-20 right-20 w-24 h-24 bg-yellow-200 rounded-full opacity-30 animate-bounce"></div>
      <div className="absolute top-1/2 left-10 w-16 h-16 bg-orange-300 rounded-full opacity-20 animate-ping"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">BazaarSetu</h1>
          <p className="text-gray-600">Connecting Street Food Vendors with Quality Suppliers</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm bg-opacity-95">
          ...
          <div className="mt-6 p-4 bg-orange-50 rounded-lg">
            ...
            <div className="text-xs text-orange-700 space-y-1">
              <p><strong>Vendor:</strong> demo@example.com / password</p>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600">
            © 2024 BazaarSetu. All rights reserved.
          </p>
        </div>
      </div>
    </div>
